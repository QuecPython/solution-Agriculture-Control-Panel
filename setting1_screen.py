...
class SettingScreen(Screen):
    ...
    def create(self):
        ...
        setting_label_1.set_text("Union")
        ...
        setting_btn_11_label.set_style_text_font(lv.font_montserrat_18, lv.STATE.DEFAULT)
        ...
        setting_btn_12_label.set_style_text_font(lv.font_montserrat_18, lv.STATE.DEFAULT)
