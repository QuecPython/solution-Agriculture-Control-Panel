...
class AlarmScreen(Screen):
    ...
    def create(self):
        ...
        alarm_label_yys.set_text("China Union")
        ...
        alarm_label_4.set_text("Status: TODO")
        ...
        alarm_label_5.set_text("Alarm History")
        ...
        alarm_label_1_7.set_text("Co2 to low.")
        ...
        alarm_label_2_7.set_text("Status: finished")
