...
class Setting2Screen(Screen):
    ...
    def create(self):
        ...
        setting2_list_1_btn_1 = setting2_list_1.add_btn(setting2_list_1_btn_1_img, "Volume")
        ...
        setting2_list_1_btn_2 = setting2_list_1.add_btn(setting2_list_1_btn_2_img, "Update")
        ...
        setting2_list_1_btn_3 = setting2_list_1.add_btn(setting2_list_1_btn_3_img, "Low Power")
        ...
        setting2_list_1_btn_4 = setting2_list_1.add_btn(setting2_list_1_btn_4_img, "Screen Rest")
        ...
        setting2_list_1_btn_5 = setting2_list_1.add_btn(setting2_list_1_btn_5_img, "Mode")
        ...
        setting2_label_1.set_text("Union")
