...
class MonitorScreen(Screen):
    ...
    def create(self):
        ...
        jiance_label_4.set_text("{}°C".format(28))
        ...
        sys_bus.subscribe("update_temp", lambda topic, data: jiance_label_4.set_text("{}°C".format(data)))
        ...
        jiance_label_6.set_text("{}%".format(40))
        ...
        sys_bus.subscribe("update_humi", lambda topic, data: jiance_label_6.set_text("{}%".format(data)))
        ...
        jiance_label_8.set_text("3500Lux")
        ...
        sys_bus.subscribe("update_temp", lambda topic, data: jiance_label_10.set_text("{}°C".format(data)))
