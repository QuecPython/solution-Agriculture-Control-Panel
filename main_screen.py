...
class MainScreen(Screen):
    ...
    def create(self):
        ...
        main_list_1_btn_0 = main_list_1.add_btn(main_list_1_btn_0_img, "Low humidity. -- 11:30")
        ...
        main_list_1_btn_1 = main_list_1.add_btn(main_list_1_btn_1_img, "Low voltage -- 11:47")
        ...
        main_list_1_btn_2 = main_list_1.add_btn(main_list_1_btn_2_img, "Low temperature. -- 11:05")
        ...
        main_label_16.set_text("Humi: {}%".format(40))
        ...
        main_label_20.set_text("{}°C".format(27))
        ...
        main_btn_3_label.set_text("Alarm")
        ...
        main_label_3.set_text("Temp: {}°C".format(28))
        ...
        main_label_6.set_text("Oxygen: {}%".format(70))
